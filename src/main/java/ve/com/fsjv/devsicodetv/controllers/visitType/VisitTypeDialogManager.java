 ...
 */
public class VisitTypeDialogManager implements ActionListener {
    ...
    private void actionList(){
        ListLastAddedDialogManager dialog =  new ListLastAddedDialogManager(TitleApp.LAST_VISIT_TYPE_ADDED_FORM_TITLE, null);
    }
