 ...
 */
public class RoleDialogManager implements ActionListener {
    ...
    private void actionList(){
        ListLastAddedDialogManager dialog = new ListLastAddedDialogManager(TitleApp.LAST_ROLE_ADDED_FORM_TITLE, null);
    }
