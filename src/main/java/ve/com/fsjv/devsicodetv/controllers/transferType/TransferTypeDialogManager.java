 ...
 */
public class TransferTypeDialogManager implements ActionListener {
    ...
    private void actionInit(){
        ...
        this.form.getChkHaveTransferTopic().setSelected(false);
        this.form.getChkHaveTransferTopic().setEnabled(false);
    ...
    private void actionEdit(){
        ...
        this.form.getChkHaveTransferTopic().setEnabled(true);
    ...
    private void actionList(){
        ListLastAddedDialogManager dialog = new ListLastAddedDialogManager(TitleApp.LAST_TRANSFER_TYPE_ADDED_FORM_TITLE, null);
    }
