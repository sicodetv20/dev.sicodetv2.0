 ...
 */
public class TransferTopicDialogManager implements ActionListener {
    ...
    private void actionInit(){
        ...
        this.form.getCmbTransferType().setSelectedIndex(0);
        this.form.getCmbTransferType().setEnabled(false);
    ...
    private void actionEdit(){
        ...
        this.form.getCmbTransferType().setEnabled(true);
    ...
    private void actionList(){
        ListLastAddedDialogManager dialog = new ListLastAddedDialogManager(TitleApp.LAST_TRANSFER_TOPIC_ADDED_FORM_TITLE, null);
    }
