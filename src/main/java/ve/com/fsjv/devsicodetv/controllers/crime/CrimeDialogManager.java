 ...
 */
public class CrimeDialogManager implements ActionListener {
    ...
    private void actionList(){
        ListLastAddedDialogManager dialog = new ListLastAddedDialogManager(TitleApp.LAST_CRIMES_ADDED_FORM_TITLE, null);
    }
